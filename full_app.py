...
# ADAIN app function
def adain_app():
    st.title("ADA IN Neural Style Transfer")
...
if st.session_state.page == 'main':
    ...
    option = st.selectbox("Choose an NST Method", ["ADA IN", "Dumoulin", "Dumoulin V2", "Dumoulin V2 Multi-Style", "Dumoulin V2 Video", "Johnson"])
    if st.button("Go"):
        st.session_state.page = option
        st.experimental_rerun()
else:
    if st.session_state.page == "ADA IN":
        adain_app()
